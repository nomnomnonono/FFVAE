...
class DecoderBurgess(nn.Module):
    def __init__(self, img_size, dataset, latent_dim=10):
        ...
        self.convT1 = nn.ConvTranspose2d(hid_channels, hid_channels // 2, kernel_size, **cnn_kwargs)
        self.convT2 = nn.ConvTranspose2d(hid_channels // 2, hid_channels // 2, kernel_size, **cnn_kwargs)
        self.convT3 = nn.ConvTranspose2d(hid_channels // 2, n_chan, kernel_size, **cnn_kwargs)
